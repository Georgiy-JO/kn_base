# Learning+ 
- Have no idea what this part will end up about, but will start with adding some links and useful info for future additional learning.
- For faster navigation use following "tags":
  - **math**
  - **physics**
  - **computer science**
...
- [!] 3Blue1Brown - **Math**, **physics**, **computer science** - difficult concepts with simple words and visualization (EN,RU,other):
